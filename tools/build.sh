#!/usr/bin/env bash
#
# Compiles the mod into Return2CenterAssembly.dll, using Besiege's OWN C# compiler
...
#
# Mod.xml loads Return2CenterAssembly.dll directly, so the mod ships as a prebuilt
...
SRC_DIR="$REPO_DIR/Return2Center/R2CScripts"
BUILD_DIR="${TMPDIR:-/tmp}/besiege-r2c-build"
OUT="$REPO_DIR/Return2Center/Return2CenterAssembly.dll"
...
mkdir -p "$BUILD_DIR"
TMP_OUT="$BUILD_DIR/Return2CenterAssembly.$$.dll"
